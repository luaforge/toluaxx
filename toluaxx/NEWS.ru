2007-08-07:
	...
	t[номер теста].received_type  -- тип переданного значения
	t[номер теста].expected_type  -- тип ожидаемого значения
	t[номер теста].received_value -- переданное значение
	t[номер теста].expected_value -- ожидаемое  значение
	t[номер теста].check_type     -- соответствие типа
	t[номер теста].check_value    -- соответствие значения
